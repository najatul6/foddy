        ...
        <div className="flex flex-col gap-12">
          <div className="flex justify-between items-center">
            ...
            <p>
              ...
              From desserts, each dish is a masterpiece
            </p>
          </div>
          <div className="flex gap-6 justify-center items-center">
            <div className="bg-deep-black hover:bg-deep-orange duration-300 p-[30px] border border-deep-orange space-y-5">
              <img src={icon1} alt="Services icons here" />
              <div className="flex flex-col gap-2">
                <h6 className="text-3xl font-cormorantGaramond font-bold capitalize">
                  Special Foods
                </h6>
              ...
              <button className="flex justify-center items-center gap-2 text-xl font-cormorantGaramond">

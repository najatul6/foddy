...
const LeftSection = () => {
  return (
    <div className="w-full h-full flex justify-center items-center gap-6 border">
      <div className="grid grid-cols-1 h-full gap-6 border w-full">
        <div className="h-full w-full border">
        <img src={Rectangle654} alt="" className="w-full h-full" />
        </div>

        <div className="font-cormorantGaramond flex flex-col border w-full h-full py-5 justify-center items-end">
